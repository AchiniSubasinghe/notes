...
intialize instance variables for default values daddi
meka constrcutor ekata kalin run wenw.eh run wenne instance block eke copy ekk constructor eke code ekt udin ena nisa thamai eka mulin display wenne.
...
oop wala concepts,
1.encapsulation=data single unit ekkt wrap karala eh data walata protection ekk denw validation ekk through(data directly access wenne na method ekk haraha yanne)
...
meh concept awe oop gana trust ekk nathi nisa

access krnw nm value ekk denna oni naththnjm value ekk ganna oni
