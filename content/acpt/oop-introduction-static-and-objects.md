...
Method scope ekk athule hadana varibales walata <span class="mark">local variable.</span>

Method athule hadana variable walata default value ekk na

Class scope eka athule hadana variable walata <span class="mark">instance variable</span> kiyala kiyanne.In oop language meh variable walat kiyanne attribute kiyala. Meh variable walata default value ekk have
...
1.  Variable ekkt value ekk daddi(copy eke)
...
Return type ekk nathi

Class eke name ekamai

Object creation ekedi invoke wena .(call wena ) special method ekt kiynw constructor.
